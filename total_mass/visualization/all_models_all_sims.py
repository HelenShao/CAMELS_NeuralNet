...
# Text
plt.text(6.6, 15, "1.57e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "1.55e-3", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "1.82e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "2.08-e3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "7.39e-4", fontsize=23)
plt.text(10.05, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "9.26e-4", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "6.87e-4", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "4.17e-4", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "4.27e-4", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
small_true = np.load("new_model_s5_SIMBA_true.npy")
small_pred = np.load("new_model_s5_SIMBA_pred.npy")
...
plt.text(12.1, 15, "4.65e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "3.70e-3", fontsize=16)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "4.57e-3", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "2.60e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "3.74e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "4.82e-3", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "3.67e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "1.36e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "7.28e-4", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "1.44e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "2.35e-2", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "5.41e-4", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "1.07e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "9.35e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "1.26e-3", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "6.41e-4", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
cb_ax3 = fig.add_axes([.906, .315, .015, .18])
fig.colorbar(plt.hexbin(true, pred, bins="log", mincnt=1, gridsize=220, cmap="plasma"),
...
#cbar.set_label("Number of Galaxies", rotation=270, fontsize=17, labelpad=25)
plt.ylabel("Predicted [$log_{10}(M_\odot /h)$]", fontsize=29)
plt.xlabel("Truth [$log_{10}(M_\odot /h)$]", fontsize=29)
...
# Text
plt.text(6.6, 15, "1.25e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "1.03e-3", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "1.24e-3", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "3.92e-3", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "4.94e-4", fontsize=23)
plt.text(10.05, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "7.44e-4", fontsize=23)
plt.text(12.05, 14.55, " %.2f"%(percentage_L)+"%", fontsize=23)
...
# Text
plt.text(6.6, 15, "6.51e-4", fontsize=23)
plt.text(6.52, 14.55, " %.2f"%(percentage_S)+"%", fontsize=23)

plt.text(10.1, 15, "3.94e-4", fontsize=23)
plt.text(10, 14.55, " %.2f"%(percentage_M)+"%", fontsize=23)

plt.text(12.1, 15, "4.35e-4", fontsize=23)
plt.text(12.05, 14.55, "%.2f"%(percentage_L)+"%", fontsize=23)
